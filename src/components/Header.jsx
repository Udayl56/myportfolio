        ...
        <div className='container bg-dark' >
            <div className="row p-2 d-flex justify-content-center align-items-center " >
                ...
                <div className=' col-6 col-md-3  p-sm-2  d-md-flex d-flex align-items-center'>
                    <a target="_blank" href="https://github.com/Udayl56" rel="noreferrer noopener" className='p-2 text-white text-decoration-none fs-4 '> <FontAwesomeIcon icon={faGithub} /><span className=' p-1'> Udayl56</span></a>
                </div>
                ...
                <div className="  col-6 col-md-3 p-md-4 p-sm-2 p-1 d-flex align-items-center justify-content-end ">
                    ...
                    <a target="_blank" href="https://www.linkedin.com/in/uday-ladhi-14a10b244/" rel="noreferrer noopener" className="ps-sm-4 pe-sm-4 p-2 bg rounded-pill text-white text-decoration-none ">
